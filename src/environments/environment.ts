...
export const environment = {
  production: false,
  webServerIp: "192.168.1.40", //"192.168.1.100",
  webServerPort: "8083",
  stampanteIp: "192.168.1.42",
  stampantePort: "9100",
  hamburgerSheet: "http://192.168.1.40:8083/spreadsheets?spreadSheetID=1VkMyVpqfR1QG5w4OY6Tu-nACiRGvBi2ehLV2TRcztCw&range=A%3AG&searchFilter&api-version=1.0",
